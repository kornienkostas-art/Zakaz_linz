...
class OrderForm(tk.Toplevel):
    """Форма создания/редактирования заказа МКЛ без выбора клиента и товара."""
    def __init__(
        self,
        master,
        clients: list[dict],
    ...
    def _build_ui(self):
        ...
        # Row 2: entries with inline − / + controls
...
class MKLOrderEditorView(ttk.Frame):
    """Встроенная форма создания/редактирования заказа МКЛ (без клиента и товара)."""
