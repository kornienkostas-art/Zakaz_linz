...
class MainWindow(ttk.Frame):
    ...
    def _build_layout(self):
        ...
        btn_test_mkl = ttk.Button(buttons, text="Проверить МКЛ сейчас", style="Menu.TButton", command=self._test_mkl_now)
        ...
        btn_test_mkl.grid(row=3, column=0, sticky="ew", pady=(12, 0))
