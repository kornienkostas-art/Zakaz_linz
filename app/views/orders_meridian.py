...
class MeridianOrdersView(ttk.Frame):
    ...
    def _open_products(self):
        def swap():
            ...
            from app.views.main import MainWindow
            ProductsView(self.master, getattr(self.master, "db", None), on_back=lambda: MeridianOrdersView(self.master, on_back=lambda: MainWindow(self.master)), kind="meridian")
        fade_transition(self.master, swap)
